...
import sty from "./PlasmicHeader2.module.css"; // plasmic-import: v-Nor-joDHwHq0/css
  ...
  return (
    ...
    >
      <p.Stack
        as={"div"}
        hasGap={true}
        className={classNames(projectcss.all, sty.freeBox__kOtbe)}
      >
        {true ? (
          <a
            className={classNames(
          ...
          >
            <Icon2Icon
              className={classNames(projectcss.all, sty.svg__kObFd)}
              role={"img"}
            />
          </a>
        ) : null}
        ...
        <p.Stack
          as={"div"}
          hasGap={true}
          className={classNames(projectcss.all, sty.freeBox___9Xn6B)}
        >
          <p.Stack
            as={"a"}
            hasGap={true}
          ...
          >
            {false ? (
              <IconIcon
                className={classNames(projectcss.all, sty.svg__sb62U)}
                role={"img"}
              />
            ) : null}
            ...
            {false ? (
              <IconIcon
                className={classNames(projectcss.all, sty.svg__shzPy)}
                role={"img"}
              />
            ) : null}
          </p.Stack>
          ...
          <p.Stack
            as={"a"}
            hasGap={true}
            className={classNames(projectcss.all, projectcss.a, sty.link__mkSt)}
            href={`/features`}
          >
            {false ? (
              <IconIcon
                className={classNames(projectcss.all, sty.svg__saTdU)}
                role={"img"}
              />
            ) : null}
            ...
            {false ? (
              <IconIcon
                className={classNames(projectcss.all, sty.svg___9N4Fq)}
                role={"img"}
              />
            ) : null}
          </p.Stack>
          ...
          >
            {false ? (
              <IconIcon
                className={classNames(projectcss.all, sty.svg__eIvMx)}
                role={"img"}
              />
            ) : null}
            ...
            {false ? (
              <IconIcon
                className={classNames(projectcss.all, sty.svg__qRyi6)}
                role={"img"}
              />
            ) : null}
          </p.Stack>
          ...
          >
            {false ? (
              <IconIcon
                className={classNames(projectcss.all, sty.svg__ocSbl)}
                role={"img"}
              />
            ) : null}
            ...
            {false ? (
              <IconIcon
                className={classNames(projectcss.all, sty.svg___65Z13)}
                role={"img"}
              />
            ) : null}
          </p.Stack>
          ...
          <p.Stack
            as={"a"}
            hasGap={true}
            className={classNames(projectcss.all, projectcss.a, sty.link__wZai)}
            href={`/blog`}
          >
            {false ? (
              <IconIcon
                className={classNames(projectcss.all, sty.svg__aEasA)}
                role={"img"}
              />
            ) : null}
            ...
            {false ? (
              <IconIcon
                className={classNames(projectcss.all, sty.svg__ejL9P)}
                role={"img"}
              />
            ) : null}
          </p.Stack>
