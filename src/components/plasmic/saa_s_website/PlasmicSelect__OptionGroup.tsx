...
import sty from "./PlasmicSelect__OptionGroup.module.css"; // plasmic-import: LxDA-FSIo3BpwH/css

import SUPER__PlasmicSelect from "./PlasmicSelect"; // plasmic-import: Ty2muMsXFBuOUP/render
      ...
      >
        {p.renderPlasmicSlot({
          defaultContents: (
            <React.Fragment>
              <Select__Option
                className={classNames("__wab_instance", sty.option__mzdQr)}
              />

              <Select__Option
                className={classNames("__wab_instance", sty.option__hJb1D)}
              />
            </React.Fragment>
          ),
          value: args.children
