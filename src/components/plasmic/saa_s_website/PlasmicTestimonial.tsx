...
import sty from "./PlasmicTestimonial.module.css"; // plasmic-import: S4xPB6uZjaHPm/css

import smalljpgXV1RRuO1HtiCel from "./images/smalljpg.jpeg"; // plasmic-import: xV1rRuO1HtiCel/picture
...
function PlasmicTestimonial__RenderFunc(props: {
  ...
  return (
    ...
    >
      <div className={classNames(projectcss.all, sty.column__dsc6W)}>
        <h2
        ...
        >
          <div className={classNames(projectcss.all, sty.column__xJm24)}>
            <p.PlasmicImg
          ...
          <div className={classNames(projectcss.all, sty.column__wk8Pr)}>
            <h5
