...
import Select__Overlay from "../../Select__Overlay"; // plasmic-import: NmSGbb5xR0qhzz/component
...
import sty from "./PlasmicSelect.module.css"; // plasmic-import: Ty2muMsXFBuOUP/css

import ChevronDownsvgIcon from "./icons/PlasmicIcon__ChevronDownsvg"; // plasmic-import: fTLq7h43gxoAHE/icon
import ChevronUpsvgIcon from "./icons/PlasmicIcon__ChevronUpsvg"; // plasmic-import: 1H-igGjXOT5Vfp/icon
  ...
  if (!("children" in props)) {
    props = {
      ...
      children: (
        <React.Fragment>
          <Select__Option
            className={classNames("__wab_instance", sty.option___2IbPo)}
            value={"value1" as const}
          >
            {"Option 1"}
          </Select__Option>
          ...
          <Select__Option
            className={classNames("__wab_instance", sty.option__dWv7T)}
            value={"value2" as const}
          >
            {"Option 2"}
          </Select__Option>
