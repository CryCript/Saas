...
import sty from "./PlasmicCtaBlock.module.css"; // plasmic-import: stbqY-IYgyhfL/css
  ...
  return (
    ...
    >
      ...
      >
        ...
        >
          <div className={classNames(projectcss.all, sty.column__ie9Wn)}>
            <h2
          ...
          <div className={classNames(projectcss.all, sty.column__hkzks)}>
            <Button
